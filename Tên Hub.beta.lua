...
local Tabs = {
    ...
    SeaEvent = Window:AddTab({ Title = "SeaEvent", Icon = "anchor" }),
...
---------------------------------------------------------------------------------
 Tabs.SeaEvent:AddParagraph({
    ...
    local ToggleBoat = Tabs.SeaEvent:AddToggle("ToggleBoat", {Title = "Auto Buy Boat", Default = false })
   ...
   local ToggleTW = Tabs.SeaEvent:AddToggle("ToggleTW", {Title = "Auto Press W", Default = false })
   ...
   ToggleTW:OnChanged(function(Value)
    ...
    local ToggleTerrorshark = Tabs.SeaEvent:AddToggle("ToggleTerrorshark", {Title = "Auto Kill Terrorshark", Default = false })
    ...
    spawn(function()
     ...
     local TogglePiranha = Tabs.SeaEvent:AddToggle("TogglePiranha", {Title = "Auto Kill Piranha", Default = false })
...
local ToggleSeaBeAst = Tabs.SeaEvent:AddToggle("ToggleSeaBeAst", {Title = "Auto Sea Beast", Default = false })
...
local ToggleAutoW = Tabs.SeaEvent:AddToggle("ToggleAutoW", {Title = "Auto Press W", Default = false })
...
local ToggleMirage = Tabs.SeaEvent:AddToggle("ToggleMirage", {Title = "Auto Mirage Island", Default = false })
...
for _,v in next, workspace.Boats.MarineBrigade:GetDescendants() do
 ...
 local AutoW = Tabs.SeaEvent:AddToggle("AutoW", {Title = "Auto Press W", Default = false })
